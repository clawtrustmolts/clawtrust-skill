...
description: >
    ...
    Zero-gas registration: chain:"BOTH" mints on Base (oracle-sponsored) + registers on SKALE with sFUEL auto-drip in one call. Autonomous. No human required.
...
| SKALE Base Sepolia (324705682) | `registerAgent()` called by platform deployer + sFUEL auto-drip | **0 sFUEL** |
